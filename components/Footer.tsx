...
export const Footer = () => {
  return (
    <section className="px-5 py-12 sm:  sm:max-w-xl md:max-w-full ">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <div className="flex items-center mt-1 space-x-3">
            {/* TODO: Update href with actual Twitter/X URL */}
            <a aria-label="Twitter" className="text-gray-500">
            ...
            <a aria-label="Instagram" className="text-gray-500">
